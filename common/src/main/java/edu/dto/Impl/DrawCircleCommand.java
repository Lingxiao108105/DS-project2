...
public class DrawCircleCommand extends DrawShapeCommand{
    ...
    public DrawCircleCommand(double x1, double y1, double x2, double y2, Color stroke, Color fill) {
    ...
    protected void drawShape(Canvas canvas) {
        ...
        DrawShapeUtil.drawCircle(graphicsContext2D,stroke.getFXColor(),fill.getFXColor(),x1,y1,x2,y2);
    }
}
